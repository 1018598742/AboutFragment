...
public class FiveFragment extends Fragment {
    ...
    private void addMyFragment() {
        ...
        fragmentTransaction.replace(R.id.content_fl, new OneFragment());
    ...
    public void onAttach(Context context) {
        ...
        Log.i(TAG, " onAttach: five");
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.i(TAG, "onCreate: five");
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        Log.i(TAG, "onViewCreated: five");
    }

    @Override
    public void onStart() {
        super.onStart();
        Log.i(TAG, "onStart: five");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.i(TAG, "onResume: five");
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.i(TAG, "onPause: five");
    }

    @Override
    public void onStop() {
        super.onStop();
        Log.i(TAG, "onStop: five");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        Log.i(TAG, "onDestroyView: five");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.i(TAG, "onDestroy: five");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        Log.i(TAG, "onDetach: five");
    }
}
